...
return(
    <div className="task-contaier d-flex direction-column align-center ">
    <div className="time">{time}</div>
        ...
        {name !==null && task === null ? (
            ...
            <div className="user-task-container d-flex align-center gap-sm">
                ...
                <div className="d-flex align-center gap-sm">
                    ...
                    <label  className={`${isChecked ? "strike-through" : ""}heading-3 d-flex align-center gap-sm cursor`}>
                        ...
                        <input className="check cursor"  type="checkbox" onChange={handleCompleteTaskChange} checked ={isChecked}/>{task}
                        </label>
